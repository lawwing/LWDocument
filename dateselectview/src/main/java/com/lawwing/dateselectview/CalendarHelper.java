...
public final class CalendarHelper
{
    ...
    public static <T extends BaseCalendarItemModel> TreeMap<String, T> getDefaultCalendarDataListByMonthOffset(
            String yearMonth, Class<T> clazz)
    {
        ...
        for (int i = 0; i < calendarViewRow * calendarViewColumn; i++)
        {
            ...
            baseCalendarItemModel.setCurrentMonth(
                    areEqualMonth(calCalendar, activeCalendar));
            baseCalendarItemModel
                    .setToday(areEqualDays(calCalendar.getTimeInMillis(),
    ...
    public static Calendar getCalendarByYearMonth(String yearMonth)
    {
        ...
        try
        {
            calendar.setTimeInMillis(
                    CalendarHelper.YEAR_MONTH_FORMAT.parse(yearMonth)
                            .getTime());
        }
        catch (ParseException e)
        {
    ...
    public static Calendar getCalendarByYearMonthDay(String yearMonthDay)
    {
        ...
        {
            calendar.setTimeInMillis(
                    CalendarHelper.YEAR_MONTH_DAY_FORMAT.parse(yearMonthDay)
                            .getTime());
        }
        catch (ParseException e)
        {
    ...
    public static int getDiffDayByTimeStamp(long startTimeStamp,
            long endTimeStamp)
    {
        return Math
                .round((endTimeStamp - startTimeStamp) * 1.0f / ONE_DAY_TIME);
    }
    ...
    public static int getDiffMonthByTime(String startTime, String endTime)
    {
        ...
        return (12 * (endCalendar.get(Calendar.YEAR)
