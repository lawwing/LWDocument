...
public abstract class BaseCalendarListAdapter<T> extends SectionedBaseAdapter
{
    ...
    // key:"yyyy-MM-dd",value: position in list which use to scroll ListView to
    // selected Date
            ...
            ViewGroup parent)
    {
        ...
        return getItemView(dateDataMap.get(date)
                .get(position), date, position, convertView, parent);
    }
    
    public abstract View getItemView(T model, String month, int pos,
     ...
     * @return the position of date in current list,setSection() will make
     *         ListView scroll to specify section exactly.
     */
    ...
    protected CalendarListView.OnCalendarViewItemClickListener.SelectedDateRegion getSelectedDateTypeByDate(
            String date)
    {
            ...
            ViewGroup parent)
    {
        ...
        else
        {
            ...
            headerViewHolder.dateText = (TextView) convertView
                    .findViewById(R.id.calendar_header_text_date);
