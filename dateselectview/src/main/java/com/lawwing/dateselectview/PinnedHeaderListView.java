...
public class PinnedHeaderListView extends ListView implements OnScrollListener
{
    ...
    {
        pullToRefreshListViewOnScroll(view,
                firstVisibleItem,
                visibleItemCount,
                totalItemCount);
    ...
    private View getSectionHeaderView(int section, View oldView)
    {
        ...
        if (shouldLayout)
        {
            ...
            {
                onSectionChangedListener.onSectionChanged(section,
                        mCurrentSection);
            }
    ...
    public void setOnSectionChangedListener(
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (mTracking)
                {
                    if (mCanRefresh)
                    {
                        ...
                        {
                            mRefreshListener
                                    .onRefresh(PinnedHeaderListView.this);
                        }
                    }
                    stopTracking();
                }
            ...
            implements AdapterView.OnItemClickListener
    {
                ...
                int rawPosition, long id)
        {
            ...
            if (adapterView.getAdapter().getClass().equals(
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        mPullHeader = LayoutInflater.from(getContext())
                .inflate(R.layout.pulldown_header, null);
    ...
    public void animateExpand()
    {
        final ObjectAnimator animator = ObjectAnimator
                .ofInt(this, "containerHeight", mTriggerRefreshHeight);
    ...
    public void smoothScrollToPosition(final int position)
    {
        ...
        if ((child != null) && ((child.getTop() == 0)
                || ((child.getTop() > 0) && !this.canScrollVertically(1))))
        {
            return;
        }
