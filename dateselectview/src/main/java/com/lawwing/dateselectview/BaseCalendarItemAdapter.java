...
import com.lawwing.dateselectview.R;
        ...
        extends BaseAdapter
{
    ...
    // key:date("yyyy-MM-dddd"),value: you custom CalendarItemModel must extend
    // com.lawwing.dateselectview.BaseCalendarItemModel
    ...
    // default calendar item view，We are appreciate of you override this
    // function to custom your View items.
    public View getView(String date, T model, View convertView,
            ViewGroup parent)
    {
        ...
        if (view == null)
        {
            view = LayoutInflater.from(mContext)
                    .inflate(R.layout.griditem_calendar_item, null);
        }
        ...
        {
            dayNum.setTextColor(
                    mContext.getResources().getColor(R.color.red_ff725f));
        ...
        {
            dayNum.setTextColor(
                    mContext.getResources().getColor(R.color.gray_bbbbbb));
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        GridView.LayoutParams layoutParams = new GridView.LayoutParams(
                CalendarView.mItemWidth, CalendarView.mItemHeight);
