...
import com.lawwing.calendarlibrary.adapter.MonthAdapter;
...
public class MonthCalendarView extends ViewPager implements OnMonthClickListener
{
    ...
    {
        MonthView monthDateView = mMonthAdapter.getViews()
                .get(getCurrentItem() - 1);
    ...
    public void setTodayToView()
    {
        ...
        MonthView monthView = mMonthAdapter.getViews()
                .get(mMonthAdapter.getMonthCount() / 2);
        if (monthView != null)
        {
            Calendar calendar = Calendar.getInstance();
            monthView.clickThisMonth(calendar.get(Calendar.YEAR),
