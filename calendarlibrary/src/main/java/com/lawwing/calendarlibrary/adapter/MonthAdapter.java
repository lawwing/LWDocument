...
import com.lawwing.calendarlibrary.MonthView;
...
public class MonthAdapter extends PagerAdapter
{
    ...
    public MonthAdapter(Context context, TypedArray array,
            MonthCalendarView monthCalendarView)
    {
        ...
        mMonthCount = array
                .getInteger(R.styleable.MonthCalendarView_month_count, 48);
    }
