package com.lawwing.calendarlibrary.adapter;

import org.joda.time.DateTime;

import com.lawwing.calendarlibrary.R;
import com.lawwing.calendarlibrary.WeekCalendarView;
import com.lawwing.calendarlibrary.WeekView;
...
public class WeekAdapter extends PagerAdapter
{
    ...
    public WeekAdapter(Context context, TypedArray array,
            WeekCalendarView weekCalendarView)
    {
        ...
        initStartDate();
        mWeekCount = array.getInteger(R.styleable.WeekCalendarView_week_count,
                220);
    }
