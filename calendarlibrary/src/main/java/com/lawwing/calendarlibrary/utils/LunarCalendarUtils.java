package com.lawwing.calendarlibrary.utils;

/**
 * Created by lawwing on 2017/11/21. 农历工具类
 */
public class LunarCalendarUtils
{
    ...
    private static final int LUNAR_INFO[] = { 0x84B6BF, /* 1900 */
            ...
            0x056A4D, 0x09AD42, 0x24AEB6, 0x04AE4A, /* 1901-1910 */
        ...
        else
        {
            if (month == 12)
            {
                if ((((daysInLunarMonth(year, month) == 29) && day == 29))
                        || ((((daysInLunarMonth(year, month) == 30)
                                && day == 30))))
                {
                    message = "除夕";
                }
    ...
    private static int[] lunar_month_days = { 1887, 0x1694, 0x16aa, 0x4ad5,
            ...
            0x1ad4, 0x52da, 0x12b6, 0xe937, 0x92e, 0x1496, 0xb64b, 0xd4a, 0xda8,
            0x95b5, 0x56c, 0x12ae, 0x492f, 0x92e, 0xcc96, 0x1a94, 0x1d4a,
            0xada9, 0xb5a, 0x56c, 0x726e, 0x125c, 0xf92d, 0x192a, 0x1a94,
            0xdb4a, 0x16aa, 0xad4, 0x955b, 0x4ba, 0x125a, 0x592b, 0x152a,
            0xf695, 0xd94, 0x16aa, 0xaab5, 0x9b4, 0x14b6, 0x6a57, 0xa56,
            0x1152a, 0x1d2a, 0xd54, 0xd5aa, 0x156a, 0x96c, 0x94ae, 0x14ae,
            0xa4c, 0x7d26, 0x1b2a, 0xeb55, 0xad4, 0x12da, 0xa95d, 0x95a, 0x149a,
            0x9a4d, 0x1a4a, 0x11aa5, 0x16a8, 0x16d4, 0xd2da, 0x12b6, 0x936,
            0x9497, 0x1496, 0x1564b, 0xd4a, 0xda8, 0xd5b4, 0x156c, 0x12ae,
            ...
            0x14b6, 0xa56, 0x7527, 0xd26, 0xee53, 0xd54, 0x15aa, 0xa9b5, 0x96c,
    ...
    public static Lunar solarToLunar(Solar solar)
    {
        ...
        long offset = solarToInt(solar.solarYear,
                solar.solarMonth,
