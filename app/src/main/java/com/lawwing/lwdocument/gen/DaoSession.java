...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig commentTypeInfoDbDaoConfig;
    private final DaoConfig paintInfoDbDaoConfig;
    private final DaoConfig saveDateDbDaoConfig;

    private final ColorInfoDbDao colorInfoDbDao;
    private final CommentInfoDbDao commentInfoDbDao;
    private final CommentTypeInfoDbDao commentTypeInfoDbDao;
    private final PaintInfoDbDao paintInfoDbDao;
    private final SaveDateDbDao saveDateDbDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        commentTypeInfoDbDaoConfig = daoConfigMap.get(CommentTypeInfoDbDao.class).clone();
        commentTypeInfoDbDaoConfig.initIdentityScope(type);

        paintInfoDbDaoConfig = daoConfigMap.get(PaintInfoDbDao.class).clone();
        paintInfoDbDaoConfig.initIdentityScope(type);

        saveDateDbDaoConfig = daoConfigMap.get(SaveDateDbDao.class).clone();
        saveDateDbDaoConfig.initIdentityScope(type);
    ...
    public CommentTypeInfoDbDao getCommentTypeInfoDbDao() {
        return commentTypeInfoDbDao;
    }
    ...
    public SaveDateDbDao getSaveDateDbDao() {
        return saveDateDbDao;
    }
