...
public class SizeUtils
{
    ...
    public static void measureViewInLV(View view)
    {
        ...
        /*
         * ViewGroup.LayoutParams p = view.getLayoutParams(); if (p == null) { p
         * = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
         * ViewGroup.LayoutParams.WRAP_CONTENT); } int width =
         * ViewGroup.getChildMeasureSpec(0, 0, p.width); int height; int
         * tempHeight = p.height; if (tempHeight > 0) { height =
         * MeasureSpec.makeMeasureSpec(tempHeight, MeasureSpec.EXACTLY); } else
