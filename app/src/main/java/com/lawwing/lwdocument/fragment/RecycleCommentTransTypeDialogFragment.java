 ...
 */
public class RecycleCommentTransTypeDialogFragment extends DialogFragment
{
    ...
    private ArrayList<CommentInfoModel> selectCommentInfos;
    
    public RecycleCommentTransTypeDialogFragment(
            ArrayList<CommentInfoModel> selectCommentInfos)
    {
        this.selectCommentInfos = selectCommentInfos;
    }
            ...
            public void onClick(View v)
            {
                ...
                if (selectTypeBean != null)
                {
                    ...
                    LWDApp.getEventBus().post(
                            new RecycleCommentTransTypeEvent(selectTypeBean));
                }
                else
                {
