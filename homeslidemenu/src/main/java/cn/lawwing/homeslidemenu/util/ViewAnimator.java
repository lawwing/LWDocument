package cn.lawwing.homeslidemenu.util;
...
import cn.lawwing.homeslidemenu.R;
import cn.lawwing.homeslidemenu.animation.FlipAnimation;
...
public class ViewAnimator<T extends Resourceble>
{
    ...
    public ViewAnimator(AppCompatActivity activity, List<T> items,
    ...
    public void showMenuContent()
    {
        ...
        {
            View viewMenu = appCompatActivity.getLayoutInflater()
    ...
    {
        this.screenShotable = animatorListener
                .onSwitch(slideMenuItem, screenShotable, topPosition);
        hideMenuContent();
    }
